...
Finally, we present the results of our application of these methods to the influenza data and conclude with a discussion.
...
### The Best 7 of 9 Models Have Similar Performance in Aggregate
...
The ensemble methods have more stable performance across the test phase seasons.  Only the \textbf{FW-reg-w} method had at least median performance in all seasons for predictions of onset timing; only \textbf{EW} and \textbf{FW-reg-w} had at least median performance in all seasons for predictions of peak timing; and only \textbf{FW-reg-wu} and \textbf{FW-reg-wui} had at least median performance in all seasons for predictions of peak incidence.
