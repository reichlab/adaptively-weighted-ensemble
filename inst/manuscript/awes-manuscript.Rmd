...
The framework described above in Equation \eqref{eqn:rhoSplineExpansion} captures these nonlinearities by estimating the functions $\rho_m(\bX)$ using a gradient tree boosting algorithm.
