...
```{r log_scores_vs_confidence, echo=FALSE, cache=TRUE, fig.height=8, fig.cap="Mean, minimum, and maximum log scores achieved by each component model for each value of model confidence, summarizing across all seasons in both the train and test phases when all three component models produced predictions."}
color_palette <- c("#E69F00", "#56B4E9", "#009E73")
