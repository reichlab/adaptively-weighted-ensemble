...
1 paragraph introduction to ensemble models, quick review of stacking literature
...
1. Simple average
2. Adaptive weights with no regularization
3. Adaptive weights with regularization
