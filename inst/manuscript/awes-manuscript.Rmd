...
For all three prediction targets, worst-case log scores and the worst-case model ranking across the five test seasons were slightly lower for the constant-weight (\textbf{CW}) model than they were for the ensembles with smoothed model weights varying by week (\textbf{FW-reg-w}). 
