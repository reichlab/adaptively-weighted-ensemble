...
grid.text("A: Component Model Weights Varying Season Week and KCDE Model Uncertainty\nSARIMA Model Uncertainty Fixed at 20",
  x = unit(0.5, "npc"),
  just = "center",
  gp = gpar(fontsize = 12),
  vp = viewport(layout.pos.row = 1, layout.pos.col = 1:2))
grid.text("B: Component Model Weights Varying Season Week and SARIMA Model Uncertainty\nKCDE Model Uncertainty Fixed at 20",
  x = unit(0.5, "npc"),
  just = "center",
  gp = gpar(fontsize = 12),
  vp = viewport(layout.pos.row = 3, layout.pos.col = 1:2))
grid.text("C: Component Model Weights Varying KCDE and SARIMA Model Uncertainty\n Season Week Fixed at 17",
  x = unit(0.5, "npc"),
  just = "center",
  gp = gpar(fontsize = 12),
